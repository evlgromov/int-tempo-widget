<template>
  <div style="z-index: 1100;font-family: 'Inter';position:absolute;bottom: 20px;right: 20px;">
    ...
    <div v-else @click="toggleShowWidget">
      <div style="border-radius: 50%;height: 100px;width: 100px;display:flex;align-items: center;justify-content:center;box-shadow: 0px 0px 8px 0px rgba(34, 60, 80, 0.2);">
