<template>
  <div style="z-index: 1100;font-family: 'Inter';position:absolute;bottom: 20px;right: 20px;">
    <div v-if="showWidget" style="overflow: hidden;display:flex;flex-direction: column;background: #fff;box-shadow: 0px 0px 15px 0px rgba(34, 60, 80, 0.2);width: 450px;height: 90vh;border-radius: 16px;">
